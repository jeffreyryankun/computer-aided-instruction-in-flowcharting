...
Begin VB.Form frmflow2 
   ...
   Begin VB.PictureBox pic10 
      ...
      Begin VB.Image input10 
         Height          =   1440
         Left            =   6840
         MouseIcon       =   "frmflow3.frx":4A773
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":4AA7D
         Top             =   480
         Width           =   3675
      End
      Begin VB.Image db10 
         Height          =   2235
         Left            =   4200
         MouseIcon       =   "frmflow3.frx":4B53B
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":4B845
         Top             =   120
         Width           =   2145
      End
      Begin VB.Image annot 
         Height          =   930
         Left            =   360
         MouseIcon       =   "frmflow3.frx":4C530
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":4C83A
         Top             =   720
         Width           =   2640
      End
   End
   Begin VB.PictureBox pic5 
      ...
      Begin VB.Image prepa5 
         Height          =   1245
         Left            =   480
         MouseIcon       =   "frmflow3.frx":97137
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":97441
         Top             =   600
         Width           =   2610
      End
      Begin VB.Image db5 
         Height          =   1860
         Left            =   8280
         MouseIcon       =   "frmflow3.frx":97EF3
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":981FD
         Top             =   240
         Width           =   1950
      End
      Begin VB.Image input5 
         Height          =   1440
         Left            =   3840
         MouseIcon       =   "frmflow3.frx":990F9
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":99403
         Top             =   480
         Width           =   3675
      End
   End
   Begin VB.PictureBox pic1 
      ...
      Begin VB.Image start 
         Height          =   975
         Left            =   360
         MouseIcon       =   "frmflow3.frx":E4634
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":E493E
         Top             =   720
         Width           =   2715
      End
      Begin VB.Image anno 
         Height          =   930
         Left            =   7560
         MouseIcon       =   "frmflow3.frx":E53D6
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":E56E0
         Top             =   840
         Width           =   2640
      End
      Begin VB.Image deci 
         Height          =   2235
         Left            =   4320
         MouseIcon       =   "frmflow3.frx":E586A
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":E5B74
         Top             =   0
         Width           =   2145
      End
   End
   Begin VB.PictureBox pic2 
      ...
      Begin VB.Image parallel 
         Height          =   1440
         Left            =   3720
         MouseIcon       =   "frmflow3.frx":130FD2
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":1312DC
         Top             =   600
         Width           =   3675
      End
      Begin VB.Image db 
         Height          =   1230
         Left            =   8640
         MouseIcon       =   "frmflow3.frx":131D9A
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":1320A4
         Top             =   600
         Width           =   1305
      End
      Begin VB.Image flow 
         Height          =   975
         Left            =   240
         MouseIcon       =   "frmflow3.frx":132B54
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":132E5E
         Top             =   720
         Width           =   1935
      End
   End
   Begin VB.PictureBox pic3 
      ...
      Begin VB.Image on3 
         Height          =   1860
         Left            =   1320
         MouseIcon       =   "frmflow3.frx":17D728
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":17DA32
         Top             =   240
         Width           =   1950
      End
      Begin VB.Image pre 
         Height          =   1620
         Left            =   7320
         MouseIcon       =   "frmflow3.frx":17E92E
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":17EC38
         Top             =   480
         Width           =   3105
      End
      Begin VB.Image off3 
         Height          =   2130
         Left            =   4680
         MouseIcon       =   "frmflow3.frx":17F619
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":17F923
         Top             =   240
         Width           =   1695
      End
   End
   Begin VB.PictureBox pic4 
      ...
      Begin VB.Image input4 
         Height          =   1440
         Left            =   0
         MouseIcon       =   "frmflow3.frx":1CAA10
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":1CAD1A
         Top             =   480
         Width           =   3675
      End
      Begin VB.Image start4 
         Height          =   1275
         Left            =   6960
         MouseIcon       =   "frmflow3.frx":1CB7D8
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":1CBAE2
         Top             =   600
         Width           =   3825
      End
      Begin VB.Image on4 
         Height          =   1860
         Left            =   4320
         MouseIcon       =   "frmflow3.frx":1CC845
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":1CCB4F
         Top             =   360
         Width           =   1950
      End
   End
   Begin VB.PictureBox pic7 
      ...
      Begin VB.Image star7 
         Height          =   1275
         Left            =   120
         MouseIcon       =   "frmflow3.frx":2181BE
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2184C8
         Top             =   600
         Width           =   3825
      End
      Begin VB.Image deci7 
         Height          =   2235
         Left            =   4440
         MouseIcon       =   "frmflow3.frx":21922B
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":219535
         Top             =   0
         Width           =   2145
      End
      Begin VB.Image proc7 
         Height          =   870
         Left            =   7440
         MouseIcon       =   "frmflow3.frx":21A220
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":21A52A
         Top             =   840
         Width           =   3045
      End
   End
   Begin VB.PictureBox pic6 
      ...
      Begin VB.Image anno6 
         Height          =   930
         Left            =   4320
         MouseIcon       =   "frmflow3.frx":265189
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":265493
         Top             =   720
         Width           =   2640
      End
      Begin VB.Image off6 
         Height          =   2130
         Left            =   8400
         MouseIcon       =   "frmflow3.frx":26561D
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":265927
         Top             =   240
         Width           =   1695
      End
      Begin VB.Image on6 
         Height          =   1860
         Left            =   1440
         MouseIcon       =   "frmflow3.frx":2662A1
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2665AB
         Top             =   360
         Width           =   1950
      End
   End
   Begin VB.PictureBox pic8 
      ...
      Begin VB.Image pre8 
         Height          =   1620
         Left            =   7440
         MouseIcon       =   "frmflow3.frx":2B1C1A
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2B1F24
         Top             =   360
         Width           =   3105
      End
      Begin VB.Image anno8 
         Height          =   930
         Left            =   3960
         MouseIcon       =   "frmflow3.frx":2B2905
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2B2C0F
         Top             =   600
         Width           =   2640
      End
      Begin VB.Image flow8 
         Height          =   975
         Left            =   600
         MouseIcon       =   "frmflow3.frx":2B2D99
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2B30A3
         Top             =   720
         Width           =   1935
      End
   End
   Begin VB.PictureBox pic9 
      ...
      Begin VB.Image flow9 
         Height          =   975
         Left            =   4440
         MouseIcon       =   "frmflow3.frx":2FD96D
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2FDC77
         Top             =   720
         Width           =   1935
      End
      Begin VB.Image on9 
         Height          =   1860
         Left            =   1080
         MouseIcon       =   "frmflow3.frx":2FDDCE
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2FE0D8
         Top             =   360
         Width           =   1950
      End
      Begin VB.Image deci9 
         Height          =   2235
         Left            =   8040
         MouseIcon       =   "frmflow3.frx":2FEFD4
         MousePointer    =   99  'Custom
         Picture         =   "frmflow3.frx":2FF2DE
         Top             =   0
         Width           =   2145
      End
   End
   ...
   Begin VB.Image Image1 
      Height          =   9735
      Left            =   0
      Picture         =   "frmflow3.frx":2FFFC9
      Top             =   -360
      Width           =   15090
   End
End
Attribute VB_Name = "frmflow2"
...
frmflowexr.lblresult.Caption = ctr
Unload Me
frmflowexr.Show
