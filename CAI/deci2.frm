...
Begin VB.Form frmdeci2 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin MSAdodcLib.Adodc Adodc1 
         ...
         UserName        =   ""
         Password        =   ""
         RecordSource    =   "select * from Flow7"
         Caption         =   "Adodc1"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
      ...
      Begin VB.Image Image11 
         ...
         Left            =   2280
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":395F3
         Top             =   6120
         Visible         =   0   'False
         Width           =   555
      End
      Begin VB.Image Image6 
         DragIcon        =   "deci2.frx":397B1
         Height          =   2085
         Left            =   2880
         MouseIcon       =   "deci2.frx":39ABB
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":39DC5
         Top             =   6960
         Visible         =   0   'False
         Width           =   2220
      End
      Begin VB.Image Image2 
         DragIcon        =   "deci2.frx":3A3C2
         Height          =   615
         Left            =   240
         MouseIcon       =   "deci2.frx":3A6CC
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3A9D6
         Top             =   5160
         Visible         =   0   'False
         Width           =   1770
      End
      Begin VB.Image Image12 
         DragIcon        =   "deci2.frx":3AD4C
         Height          =   615
         Left            =   240
         MouseIcon       =   "deci2.frx":3B056
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3B360
         Top             =   5160
         Visible         =   0   'False
         Width           =   1770
      End
      Begin VB.Image Image4 
         DragIcon        =   "deci2.frx":3B6D6
         Height          =   870
         Left            =   2040
         MouseIcon       =   "deci2.frx":3B9E0
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3BCEA
         Top             =   5040
         Visible         =   0   'False
         Width           =   2970
      End
      Begin VB.Image Image8 
         DragIcon        =   "deci2.frx":3C000
         Height          =   870
         Left            =   2040
         MouseIcon       =   "deci2.frx":3C30A
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3C614
         Top             =   5040
         Visible         =   0   'False
         Width           =   2970
      End
      Begin VB.Image Image10 
         DragIcon        =   "deci2.frx":3C92A
         Height          =   870
         Left            =   2040
         MouseIcon       =   "deci2.frx":3CC34
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3CF3E
         Top             =   5040
         Visible         =   0   'False
         Width           =   2970
      End
      Begin VB.Image imgcp 
         Height          =   1245
         Left            =   1680
         MouseIcon       =   "deci2.frx":3D254
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3D55E
      ...
      Begin VB.Image imgright 
         Height          =   555
         Left            =   360
         MouseIcon       =   "deci2.frx":3E2B5
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3E5BF
      ...
      Begin VB.Image imgdown 
         Height          =   1095
         Left            =   1800
         MouseIcon       =   "deci2.frx":3E74F
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3EA59
         ToolTipText     =   "ADD FLOWLINE"
         Top             =   6120
         Width           =   555
      End
      Begin VB.Image imgi 
         Height          =   420
         Left            =   1800
         MouseIcon       =   "deci2.frx":3EC17
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3EF21
      ...
      Begin VB.Image imgd 
         Height          =   990
         Left            =   360
         MouseIcon       =   "deci2.frx":3F08C
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3F396
         ToolTipText     =   "ADD TERMINAL SYMBOL"
         Top             =   6120
         Width           =   930
      End
      Begin VB.Image imgt 
         Height          =   420
         Left            =   360
         MouseIcon       =   "deci2.frx":3F750
         MousePointer    =   99  'Custom
         Picture         =   "deci2.frx":3FA5A
         ToolTipText     =   "ADD TERMINAL SYMBOL"
         Top             =   5280
         Width           =   1125
      End
...
frmtextd2.Picture1.Visible = True
frmtextd2.Text1.SetFocus
...
frmtextd2.Picture2.Visible = True
frmtextd2.Text2.SetFocus
...
frmtextd2.Picture3.Visible = True
frmtextd2.Text3.SetFocus
...
frmtextd2.Picture4.Visible = True
frmtextd2.Text4.SetFocus
...
frmtextd2.Picture5.Visible = True
frmtextd2.Text5.SetFocus
...
frmtextd2.Picture6.Visible = True
frmtextd2.Text6.SetFocus
