...
Begin VB.Form frmupdatepre2 
   ...
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   Picture         =   "frmupdatepre2.frx":0000
   ScaleHeight     =   10005
   ScaleWidth      =   17790
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   9495
      Left            =   0
      Picture         =   "frmupdatepre2.frx":38614
      ScaleHeight     =   9495
      ScaleWidth      =   17775
      TabIndex        =   0
      Top             =   600
      ...
      Begin VB.TextBox txtq9 
         ...
         Left            =   9600
         TabIndex        =   41
         Text            =   "A small labeled, circular flowchart shape used to indicate a jump in a process flow."
         Top             =   5160
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq10 
         ...
         Left            =   9600
         TabIndex        =   46
         Text            =   "A parallellogram that indicates an input or output."
         Top             =   6600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq6 
         ...
         Left            =   9600
         TabIndex        =   26
         Text            =   "It is an oval flowchart indicating the start or end of the process."
         Top             =   600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq7 
         ...
         Left            =   9600
         TabIndex        =   31
         Text            =   "A rectangular flowchart shape indicating how it is done."
         Top             =   2160
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq5 
         ...
         Left            =   600
         TabIndex        =   21
         Text            =   "Who discovered flowcharts?"
         Top             =   6600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq1 
         ...
         Left            =   600
         TabIndex        =   1
         Text            =   "What is a diagrammatic representation that illustrates the sequence of operations to be performed?"
         Top             =   600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq2 
         ...
         Left            =   600
         TabIndex        =   6
         Text            =   "It is a representation of series  of logic operations to satisfy network requirements."
         Top             =   2160
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq3 
         ...
         Left            =   600
         TabIndex        =   11
         Text            =   "It  is a presentation or a written description of some regular and common parts of the flow."
         Top             =   3600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq4 
         ...
         Left            =   600
         TabIndex        =   16
         Text            =   "Below is the benefits of flowcharts as follows, which one is not correct?"
         Top             =   5160
         Width           =   8295
      End
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmupdatepre2.frx":70C28
         Height          =   735
         Left            =   4200
         TabIndex        =   206
         Top             =   8160
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   9495
      Left            =   0
      Picture         =   "frmupdatepre2.frx":70C3D
      ScaleHeight     =   9495
      ScaleWidth      =   17775
      TabIndex        =   153
      Top             =   600
      ...
      Begin VB.TextBox txtq14 
         ...
         Left            =   600
         TabIndex        =   66
         Text            =   "In drawing a proper flowchart, all necessary requirements should be listed out in ______ order."
         Top             =   5160
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq13 
         ...
         Left            =   600
         TabIndex        =   61
         Text            =   "Why do we need to use flowcharts?"
         Top             =   3600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq15 
         ...
         Left            =   600
         TabIndex        =   71
         Text            =   "The flowchart should be _______, neat and easy to follow."
         Top             =   6600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq17 
         ...
         Left            =   9600
         TabIndex        =   81
         Text            =   "The flowchart helps in ________ process."
         Top             =   2160
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq16 
         ...
         Left            =   9600
         TabIndex        =   76
         Text            =   "A flowchart is a tool for ________ processes, programs or systems."
         Top             =   600
         Width           =   8295
      End
      ...
      Begin VB.TextBox txtq19 
         ...
         Left            =   9600
         TabIndex        =   91
         Text            =   "Flowchart are generally drawn in the early stages of ________ computer solutions."
         Top             =   5160
         Width           =   8295
      End
   ...
   End
End
Attribute VB_Name = "frmupdatepre2"
...
Me.Hide
frmupdatepre3.Show
frmupdatepre3.Picture1.Visible = True
frmupdatepre3.Picture2.Visible = False
